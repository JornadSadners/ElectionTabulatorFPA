<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="VerifyInformation.aspx.cs" Inherits="ElectionTabulatorFPA.VerifyInformation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="VerificationStyleSheet.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" CssClass="panel">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtLastName" Display="Dynamic" ErrorMessage="You must enter your last name"></asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="Label3" runat="server" Text="DOB (dd-mm-yyyy)"></asp:Label>
            <br />
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtCountry" Display="Dynamic" ErrorMessage="You must enter your country"></asp:RequiredFieldValidator>
            <br />
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtEmail" Display="Dynamic" ErrorMessage="Email is invalid" ValidationExpression="^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$"></asp:RegularExpressionValidator>
            <br />
            <br />
            <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" CssClass="btn btn-lg font-weight-bold"/>
        </asp:Panel>
